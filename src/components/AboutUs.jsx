  ...
  return (
    <section className="py-8 sm:py-12 md:py-16 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl sm:text-3xl font-bold text-center text-green-800 mb-6 sm:mb-8">About Us</h2>
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 md:pl-8">
            <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">Meet the Artist</h3>
