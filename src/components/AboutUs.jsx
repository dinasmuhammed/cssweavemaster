  ...
  return (
    <section className="py-8 sm:py-12 md:py-16 relative overflow-hidden" style={{ backgroundColor: '#FCEBD033' }}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-green-800 mb-6 sm:mb-8 md:mb-12">
          About Us
        </h2>
        ...
        <div className="flex flex-col md:flex-row items-start gap-8 md:gap-12">
          ...
          <div className="w-full md:w-1/2 md:pl-8 relative space-y-4 sm:space-y-6">
